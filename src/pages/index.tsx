...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-dino-dark text-dino-text flex flex-col">
            {/* Navigation */}
            <header className="flex justify-between items-center px-12 py-6 border-b border-dino-border">
                ...
                <nav className="flex gap-8 items-center">
                    ...
                    <button onClick={handleRedirectAuthPage} className="bg-emerald-500 hover:bg-emerald-600 px-6 py-2 rounded-full font-semibold transition">Sign In</button>
                </nav>
            </header>
            ...
            {/* Features */}
            <section id="features" className="px-12 py-16 border-t border-dino-border">
